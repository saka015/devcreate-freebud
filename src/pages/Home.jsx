      ...
      <div className="flex mt-24 min-h-screen ">
        <div className="w-1/2 p-4">
          ...
          <div className="flex justify-center mt-10">
            <button className="w-48 bg-blue-400 rounded-3xl hover:bg-white text-white border p-3 hover:text-teal-400 font-semibold transition-all hover:border-teal-700">
              Explore
            </button>
          </div>
        </div>
